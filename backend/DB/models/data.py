...
from sqlalchemy import Column, BigInteger, Integer, ForeignKey, Float, DateTime, func
...
class Data(Base):
    ...
    graph_type_id = Column(Integer, ForeignKey("graph_types.id", ondelete="CASCADE"), nullable=False)
    ...
    graph_type = relationship("GraphType", back_populates="data_points")
